...
# S3 Bucket for Static Assets and 3D Models
...
resource "aws_cloudfront_origin_access_identity" "assets" {
  comment = "access-identity-${aws_s3_bucket.assets.bucket_regional_domain_name}"
}

# Elastic Beanstalk Application
resource "aws_elastic_beanstalk_application" "app" {
  name        = var.project_name
  description = "3D E-commerce Application"
}
...
resource "aws_route53_record" "app" {
  ...
  alias {
    ...
    zone_id               = aws_elastic_beanstalk_environment.app_env.zone_id
